...
downloadBtn.addEventListener("click", () => {
    let resumePath =
        "https://docs.google.com/document/d/1u28h3JPXMj89U9Z1UF3BtbKalS8yZLzn_YV2q6S-4DY/edit";
...
function sendEmail() {
    ...
    Email.send({
        ...
        Username: "login2aditisengar@gmail.com",
        Password: "C0D315697996041EC5B9D702DB44E1B1191C",
        To: "login2aditisengar@gmail.com",
        From: email.value,
        Subject: sub.value,
        Body: msg.value,
    }).then((message) =>
